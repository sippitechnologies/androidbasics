...
import kotlinx.android.synthetic.main.activity_drawerlayoutbottomnavigationbar.*


class BottomActionBarWithDrawerLayout : AppCompatActivity(),
    NavigationView.OnNavigationItemSelectedListener {

    lateinit var actionBarDrawerToggle: ActionBarDrawerToggle
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_drawerlayoutbottomnavigationbar)
